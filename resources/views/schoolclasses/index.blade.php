 ...
 @section('content')
        ...
        <div class="mb-8 flex items-end justify-between border-b border-[#E5E3DB] pb-5"> 
            ...
            <a href="{{ route('schoolclasses.create') }}" class="bg-[#16213A] px-5 py-2.5 text-sm font-medium text-white transition hover:bg-[#26324f]"> 
                    ...
                    @foreach ($classes as $class)
                        ...
                        <td class="px-5 py-4"> 
                            ...
                            <div class="flex justify-end gap-4 text-xs font-medium"> 
                                ...
                                <a href="{{ route('schoolclasses.show', $class['id']) }}" 
                                class="text-[#16213A] hover:text-[#A16207]">Lihat</a> 
 
                                <a href="{{ route('schoolclasses.edit', $class['id']) }}" 
