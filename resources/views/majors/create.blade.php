...
@section('content')
   <div class="mb-8 border-b border-[#E5E3DB] pb-5">
            ...
            <p class="mt-1 text-sm text-slate-500">Isi data untuk mendaftarkan jurusan baru ke dalam sistem sekolah.</p>
        </div>
        ...
        <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
            ...
            <div>
                ...
                <textarea id="description" name="description" placeholder="Penjelasan singkat tentang jurusan"
